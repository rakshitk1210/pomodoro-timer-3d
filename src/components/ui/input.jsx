...
/* forwardRef, unlike current shadcn source: that targets React 19, where a
   function component receives `ref` as a plain prop. This project is on
   React 18, where it does not — the ref would silently be null. */
